      ...
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between">
            ...
            <div className="hidden md:flex items-center space-x-6">
              ...
              {/* Language Switch */}
              <button
                onClick={handleSwitchToIndonesian}
        ...
        >
          <div className="px-2 pt-2 pb-3 space-y-1">
            ...
            <button
              onClick={handleSwitchToIndonesian}
              className="block w-full mt-4 px-6 py-3 border border-gray-300 dark:border-gray-700 rounded-lg font-medium text-base hover:bg-gray-100 dark:hover:bg-gray-800 transition-all duration-300 text-center text-gray-700 dark:text-gray-200"
            >
              🇮🇩 Indonesian
            </button>
